"""Proof-gated MARC2 F06/F07 private structural discriminator.
...
from neurodecodekit.datasets import marc2_r5_two_route_discriminator as discriminator


LANE_ID = "MARC2-VR22P"
SCHEMA_VERSION = "0.1.0"
PLAN_SCHEMA_NAME = "neurodecodekit.marc2_r5_private_discriminator_plan"
QUALIFICATION_SCHEMA_NAME = "neurodecodekit.marc2_r5_private_discriminator_qualification"
REPORT_SCHEMA_NAME = "neurodecodekit.marc2_r5_private_discriminator_report"
PRIVATE_SCHEMA_NAME = "neurodecodekit.marc2_r5_private_discriminator_cohort"
CERTIFICATE_SCHEMA_NAME = "neurodecodekit.marc2_r5_private_discriminator_readiness_certificate"
MARKER_SCHEMA_NAME = "neurodecodekit.marc2_r5_private_discriminator_consumed"

DECISION_RELATIVE_PATH = Path(
    "registries/marc2_r5_private_discriminator_authorization_decision.v0.json"
)
...
VR20A_IMPLEMENTATION_RELATIVE_PATH = Path(
    "registries/marc2_published_task_selector_repair_implementation.v0.json"
)
VR20A_RESULT_RELATIVE_PATH = Path("registries/marc2_published_task_selector_repair_result.v0.json")
VR21A_MODULE_RELATIVE_PATH = Path(
    "src/neurodecodekit/datasets/marc2_r5_two_route_discriminator.py"
)
VR21A_IMPLEMENTATION_RELATIVE_PATH = Path(
    "registries/marc2_r5_two_route_discriminator_implementation.v0.json"
)
VR21A_RESULT_RELATIVE_PATH = Path(
    "registries/marc2_r5_two_route_discriminator_result.v0.json"
)
READINESS_RELATIVE_PATH = Path(".codex_work/marc2_machine_readiness/vr22p/readiness.v0.json")
OUTPUT_ROOT_RELATIVE_PATH = Path(".codex_work/marc2_r5_private_discriminator/v0")
...
DECISION_SHA256 = "33fb0a811d364a02db7e05baf58778bed65b286920bab260a1b31a6a98bd921e"
REQUEST_SHA256 = "7a61751d3623ee499d492e0f762134d7a73de81264d18afa80b910d347ee32fb"
GREEN_DECISION_COMMIT = "197f253e9e0411085f6ecdccf466f9f7059bd479"
GREEN_DECISION_CI_RUN_ID = 32_593_234_295
GREEN_DECISION_BASE_JOB_ID = 97_080_176_920
GREEN_DECISION_OPTIONAL_JOB_ID = 97_080_176_717
VR20A_MODULE_SHA256 = "9f6ebe63dbeb1cd778a71ff395d698159acc672b187e5121d5d5e734d9e05fba"
VR20A_IMPLEMENTATION_SHA256 = "90a28059bb4d0ba92aa7dd596cb6050b141900d83415e93461dcb7c16c1fa0d1"
VR20A_RESULT_SHA256 = "92d10a5c23c1795d4a4094cbe18a23d5239ad59aa9a6421a9a6bafb3a7c56dfd"
VR21A_MODULE_SHA256 = "367f219b04c4c6a943435c1c36d2191b167c6b74f16bc8b40afcccd83e73b601"
VR21A_IMPLEMENTATION_SHA256 = "1e5728ab9e0e4fecb80b0084089e9d988437faa480f11bdb6f1d527241174057"
VR21A_RESULT_SHA256 = "a18e0cea28b8acb604d9807bae8ea51f88b511d6ff7db82755a9f322b87222db"
...
SUCCESS_ROUTE = "MARC2VR22P-G1"
PRIVATE_SUCCESS_ROUTE = "MARC2VR22P-R1"
PRIVATE_FAILURE_ROUTES = tuple(f"MARC2VR22P-R{index}" for index in range(2, 7))
REFUSAL_ROUTES = tuple(f"MARC2VR22P-F{index:02d}" for index in range(1, 13))
...
GENERATED_CASE_ROUTES = {
    ...
    "taxonomy_F06": PRIVATE_FAILURE_ROUTES[2],
    "selection_F07": PRIVATE_FAILURE_ROUTES[3],
}
...
class R5PrivateDiscriminatorRefusal(RuntimeError):
    ...
    def __init__(self, route: str, reason: str):
        if route not in REFUSAL_ROUTES and route not in PRIVATE_FAILURE_ROUTES:
            raise ValueError("unknown MARC2-VR22P refusal route")
...
def _canonical_json_bytes(value: Any) -> bytes:
    try:
        ...
        raise R5PrivateDiscriminatorRefusal(
...
def _strict_object(pairs: list[tuple[str, Any]]) -> dict[str, Any]:
    ...
    for key, value in pairs:
        if key in result:
            raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[6], "duplicate JSON key")
        result[key] = value
    return result


def _reject_constant(_value: str) -> None:
    raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[6], "non-finite JSON number")
...
def _strict_json(payload: bytes) -> dict[str, Any]:
    ...
    except R5PrivateDiscriminatorRefusal:
        raise
    except (UnicodeDecodeError, json.JSONDecodeError) as exc:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[6], "strict JSON parse failed") from exc
    if not isinstance(value, dict):
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[6], "JSON root is not an object")
    return value


def _read_tracked(root: Path, relative: Path) -> bytes:
    if relative.is_absolute() or ".." in relative.parts:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[0], "tracked path is unsafe")
    path = root / relative
    info = path.lstat()
...
def load_decision(root: Path | None = None) -> dict[str, Any]:
    ...
    if _sha256_bytes(payload) != DECISION_SHA256:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[0], "decision identity differs")
...
def _validate_upstream_artifacts(root: Path | None = None) -> None:
    ...
    expected = (
        ...
        (VR20A_IMPLEMENTATION_RELATIVE_PATH, VR20A_IMPLEMENTATION_SHA256),
        (VR20A_RESULT_RELATIVE_PATH, VR20A_RESULT_SHA256),
        (VR21A_MODULE_RELATIVE_PATH, VR21A_MODULE_SHA256),
        (VR21A_IMPLEMENTATION_RELATIVE_PATH, VR21A_IMPLEMENTATION_SHA256),
        (VR21A_RESULT_RELATIVE_PATH, VR21A_RESULT_SHA256),
    )
...
def _validate_decision(decision: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        != "neurodecodekit.marc2_r5_private_discriminator_authorization_decision"
        or decision.get("lane_id") != LANE_ID
        or decision.get("authorization_parent_commit")
        != "026ecd2a00265e30a221149397bc11a3ee4d4d64"
        or not isinstance(request, dict)
        or request.get("commit") != "c90b5adae161127db8aa8c43d1101db8672b44e0"
        or request.get("both_required_jobs_green") is not True
        or not isinstance(proof, dict)
        or proof.get("commit") != "026ecd2a00265e30a221149397bc11a3ee4d4d64"
        ...
        or authority.get("one_VR21A_map_call_maximum_after_stage_1_proof_green") is not True
        ...
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[0], "decision contract differs")
...
def _validate_thread_environment(environment: Mapping[str, str] | None = None) -> None:
    ...
    if any(values.get(name) != "1" for name in THREAD_ENVIRONMENT):
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[1], "thread environment is not one")
...
def _assert_resources(
    ...
    if (
        ...
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[10], "resource or output cap exceeded")


def _safe_parent_chain(root: Path, relative: Path) -> None:
    if relative.is_absolute() or ".." in relative.parts:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[2], "unsafe fixed path")
    current = root
    for part in relative.parts[:-1]:
        current = current / part
        if current.exists() and current.is_symlink():
            raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[2], "fixed parent is a symlink")
...
def _create_fresh_directory(root: Path, relative: Path) -> Path:
    ...
    if path.exists() or path.is_symlink():
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[2], "fixed output already exists")
...
def _write_exclusive(path: Path, payload: bytes, mode: int) -> int:
    ...
    try:
        ...
        if written != len(payload):
            raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[9], "short fixed-path write")
    finally:
        os.close(descriptor)
    os.chmod(path, mode)
    return len(payload)
...
def _sample_time(value: Any) -> datetime:
    if not isinstance(value, str):
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[4], "readiness timestamp is missing")
    try:
    ...
    if parsed.tzinfo is None:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[4], "readiness timestamp lacks timezone")
    return parsed.astimezone(UTC)


def _validate_samples(samples: Sequence[Mapping[str, Any]]) -> None:
    if len(samples) != REQUIRED_PASSING_SAMPLES:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[4], "readiness sample count differs")
    ...
    for index, sample in enumerate(samples):
        if (
            ...
            raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[4], "readiness sample failed")
...
def _preflight_source(path: Path, identity: Mapping[str, Any]) -> None:
    ...
    if stat.S_IMODE(info.st_mode) != identity["mode"] or info.st_size != identity["bytes"]:
        raise R5PrivateDiscriminatorRefusal(PRIVATE_FAILURE_ROUTES[1], "source identity differs")
...
def _private_manifest(
    repaired: repair.PublishedTaskSelection,
    *,
    source_sha256: str,
    ...
    return {
        ...
        "VR21A_module_sha256": VR21A_MODULE_SHA256,
...
def _aggregate_report(
    ...
    *,
    ...
    counters["VR20A_calls"] = 1
    counters["VR21A_map_calls"] = 0
    ...
    report = {
        ...
        "claim_boundary": {
            "engineering_capability": "bounded target-free F06/F07 structural discrimination",
...
def _private_route_for_refusal(exc: R5PrivateDiscriminatorRefusal) -> str:
    ...
    counters.update(
        {
            ...
            "VR20A_calls": accounting["VR20A_calls"],
            "VR21A_map_calls": accounting["VR21A_map_calls"],
...
def _build_generated_case(generated_case: str, order: str) -> dict[str, Any]:
    ...
    if order not in repair.ORDERS:
        raise R5PrivateDiscriminatorRefusal(
            REFUSAL_ROUTES[7], "generated order is not registered"
        )
    candidate = repair.build_generated_variant("published_four_digit", order)
    if generated_case == "taxonomy_F06":
        return discriminator._unknown_participant_witness(candidate)
    if generated_case == "selection_F07":
        return repair._mutated_witness(candidate, "semantic_run_zero")
    return candidate


def _adapt_and_discriminate(
    source: Mapping[str, Any], accounting: dict[str, int]
) -> repair.PublishedTaskSelection:
    before = repair.vr2._canonical_source_bytes(source)
    accounting["VR20A_calls"] += 1
    try:
        selected = repair.adapt_published_task_source(source)
    except repair.PublishedTaskSelectorRepairRefusal as exc:
        after = repair.vr2._canonical_source_bytes(source)
        if after != before:
            raise R5PrivateDiscriminatorRefusal(
                PRIVATE_FAILURE_ROUTES[4], "VR20A mutated source"
            ) from exc
        if exc.route not in (repair.REFUSAL_ROUTES[5], repair.REFUSAL_ROUTES[6]):
            raise R5PrivateDiscriminatorRefusal(
                PRIVATE_FAILURE_ROUTES[4], "VR20A route is outside F06/F07"
            ) from exc
        accounting["VR21A_map_calls"] += 1
        mapped = discriminator._map_upstream_route(exc.route)
        if mapped == discriminator.TAXONOMY_ROUTE:
            route = PRIVATE_FAILURE_ROUTES[2]
        elif mapped == discriminator.SELECTION_ROUTE:
            route = PRIVATE_FAILURE_ROUTES[3]
        else:  # pragma: no cover - exact map cannot return success for a refusal
            route = PRIVATE_FAILURE_ROUTES[4]
        raise R5PrivateDiscriminatorRefusal(
            route, "VR20A refusal mapped through VR21A"
        ) from exc
    after = repair.vr2._canonical_source_bytes(source)
    if after != before:
        raise R5PrivateDiscriminatorRefusal(
...
def _run_fixed_sequence(
    ...
    *,
    ...
    if len(certificate_bytes) > MAX_CERTIFICATE_BYTES:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[10], "readiness certificate exceeds cap")
    ...
    def finish_failure(exc: R5PrivateDiscriminatorRefusal) -> dict[str, Any]:
    ...
    except R5PrivateDiscriminatorRefusal as exc:
    ...
    try:
        ...
        repaired = _adapt_and_discriminate(source, accounting)
    except R5PrivateDiscriminatorRefusal as exc:
        return finish_failure(exc)
...
_ENVELOPE_EXPECTED: dict[str, Any] = {
    ...
    "marker_writes": 1,
    "VR20A_calls": 1,
    "VR20A_source_exact": True,
    "VR20A_selection_deterministic": True,
    "VR20A_required_task": "reachingandgrasping",
    "VR20A_task_aliases_allowed": False,
    "VR20A_task_casefolding_allowed": False,
    "VR20A_task_prefixes_allowed": False,
    "VR20A_task_suffixes_allowed": False,
    "VR20A_run_token_regex": "[0-9]+",
    "VR20A_width_ceiling_absent": True,
    "VR20A_numeric_identity_canonical": True,
    "VR20A_selected_semantic_runs": "1,2,3",
    "VR20A_source_exact_names": True,
    "VR20A_source_exact_reservation": True,
    "VR20A_companion_spelling_exact": True,
    "VR20A_normalized_collision_refused": True,
    "VR20A_source_immutable": True,
    "VR20A_calls_per_path": 1,
    "VR21A_map_exact": True,
    "VR21A_map_calls_on_success": 0,
    "VR21A_map_calls_on_failure": 1,
    "VR21A_F06_route": "MARC2VR21A-R1",
    "VR21A_F07_route": "MARC2VR21A-R2",
    "VR22P_F06_route": "MARC2VR22P-R4",
    "VR22P_F07_route": "MARC2VR22P-R5",
...
def _envelope_route(key: str) -> str:
    ...
    if key.startswith("VR20A") or key.startswith("VR21A") or key.startswith("VR22P"):
...
def _validate_envelope(envelope: Mapping[str, Any]) -> None:
    if set(envelope) != set(_ENVELOPE_EXPECTED):
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[11], "execution envelope fields differ")
...
def qualify_generated(
    *,
    ...
    for replay in range(2):
        for generated_case in GENERATED_CASES:
            for order in repair.ORDERS:
                ...
                with tempfile.TemporaryDirectory(prefix="ndk-vr22p-") as temporary:
                    root = Path(temporary)
                    source_path = root / PRIVATE_SOURCE_RELATIVE_PATH
                    ...
                    outcome = {
                        ...
                        "VR20A_calls": result["VR20A_calls"],
                        "VR21A_map_calls": result["VR21A_map_calls"],
                        "source_content_opens": result["source_content_opens"],
                    }
                    if generated_case == "success":
    ...
    if (
        ...
        or sum(item["VR20A_calls"] for item in outcomes) != 12
        or sum(item["VR21A_map_calls"] for item in outcomes) != 8
    ...
    if direct_refusals < 60:
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[11], "direct refusal floor not met")
    elapsed = clock() - started
    rss = peak_rss()
    report = {
        ...
        "matrix": {
            ...
            "VR20A_calls": sum(item["VR20A_calls"] for item in outcomes),
            "VR21A_map_calls": sum(
                item["VR21A_map_calls"] for item in outcomes
            ),
        ...
        "claim_boundary": {
            "engineering_capability": "generated fixed-path F06/F07 discriminator qualification",
            "scientific_claim_not_established": (
...
def _load_implementation(root: Path) -> dict[str, Any]:
    ...
    if (
        record.get("schema_name") != "neurodecodekit.marc2_r5_private_discriminator_implementation"
        or record.get("lane_id") != LANE_ID
    ):
        raise R5PrivateDiscriminatorRefusal(REFUSAL_ROUTES[0], "implementation record differs")
    return record
...
def _collect_readiness(root: Path) -> list[dict[str, Any]]:
    ...
    raise R5PrivateDiscriminatorRefusal(PRIVATE_FAILURE_ROUTES[0], "machine readiness did not pass")
...
def build_plan() -> dict[str, Any]:
    ...
    return {
        ...
        "generated_refusal_paths": 8,
        "VR20A_calls": 12,
        "VR21A_map_calls": 8,
        "direct_refusal_minimum": 60,
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Proof-gated MARC2 target-free F06/F07 structural discriminator."
    )
