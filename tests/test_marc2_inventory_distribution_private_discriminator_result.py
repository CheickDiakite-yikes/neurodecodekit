...
RESULT = (
    ROOT
    / "registries/marc2_inventory_distribution_private_discriminator_result.v0.json"
)


class Marc2InventoryDistributionPrivateDiscriminatorResultTests(unittest.TestCase):
    @classmethod
    ...
    def test_result_is_generated_stage_1_only(self):
        ...
        self.assertEqual(self.result["lane_id"], "MARC2-VR30P")
        self.assertEqual(self.result["route"], "MARC2VR30P-G1")
        self.assertEqual(
    ...
    def test_matrix_is_exact_and_deterministic(self):
        ...
        self.assertEqual(matrix["nested_R1_filter_calls"], 16)
        self.assertEqual(
            matrix["VR30P_route_counts"],
            {
                "MARC2VR30P-G1": 4,
                "MARC2VR30P-G2": 4,
                "MARC2VR30P-R1": 8,
