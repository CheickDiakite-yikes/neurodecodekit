...
REQUEST_PATH = (
    ROOT
    / "registries"
    / "marc2_variable_width_private_confirmation_authorization_request.v0.json"
)
DOC_PATH = ROOT / "docs" / "MARC_2_VARIABLE_WIDTH_PRIVATE_CONFIRMATION_AUTHORIZATION_PACKET.md"


class Marc2VariableWidthPrivateConfirmationRequestTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.request = json.loads(REQUEST_PATH.read_text(encoding="utf-8"))

    def test_request_identity_and_authority_are_exactly_all_false(self):
        self.assertEqual(self.request["lane_id"], "MARC2-VR16P")
        self.assertEqual(
            self.request["status"],
    ...
    def test_every_fixed_input_is_exact_and_tracked(self):
        ...
        self.assertEqual(sum(row["bytes"] for row in rows), 180_905)
    ...
    def test_green_proof_chain_is_exact(self):
        ...
        self.assertEqual(
            ...
            "6f92b84c7be67848c7d09b567f13b08a14d33f5c",
        )
        self.assertEqual(proof["implementation_CI_run_id"], 32_459_984_049)
        self.assertEqual(proof["implementation_base_job_id"], 96_704_807_926)
        self.assertEqual(proof["implementation_optional_job_id"], 96_704_808_178)
        self.assertEqual(
            proof["proof_closeout_commit"],
            "91dd117ca582f9cc3256f7a4feb0f498be8e3956",
        )
        self.assertEqual(proof["proof_closeout_CI_run_id"], 32_460_539_227)
        self.assertEqual(proof["proof_closeout_base_job_id"], 96_706_432_536)
        self.assertEqual(proof["proof_closeout_optional_job_id"], 96_706_432_846)
    ...
    def test_fixed_paths_are_distinct_and_have_no_override(self):
        ...
        self.assertTrue(paths["readiness_certificate"].endswith("vr16p/readiness.v0.json"))
        self.assertTrue(
            paths["output_root"].endswith("marc2_variable_width_private_confirmation/v0")
        )
        ...
        self.assertFalse(surface["retry_resume_fallback_width_or_route_override_allowed"])
    ...
    def test_two_stage_order_and_route_table_are_frozen(self):
        ...
        self.assertEqual(
            ...
            [f"MARC2VR16P-R{index}" for index in range(1, 7)],
        )
    ...
    def test_generated_stage_and_one_shot_resources_are_bounded(self):
        ...
        self.assertEqual(generated["VR16A_calls_per_path"], 1)
        self.assertGreaterEqual(generated["direct_refusal_minimum"], 70)
        ...
        self.assertEqual(caps["VR16A_adapter_calls"], 1)
