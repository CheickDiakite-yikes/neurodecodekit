...
RESULT = (
    ROOT
    / "registries/marc2_inventory_taxonomy_private_discriminator_result.v0.json"
)


class Marc2InventoryTaxonomyPrivateDiscriminatorResultTests(unittest.TestCase):
    @classmethod
    ...
    def test_result_is_generated_stage_1_only(self):
        ...
        self.assertEqual(self.result["lane_id"], "MARC2-VR28P")
        self.assertEqual(self.result["route"], "MARC2VR28P-G1")
        self.assertEqual(
    ...
    def test_matrix_is_exact_and_deterministic(self):
        ...
        self.assertEqual(matrix["VR27A_map_calls"], 20)
        self.assertEqual(
