...
REQUEST_PATH = (
    ROOT
    / "registries/marc2_suffix_identity_private_discriminator_authorization_request.v0.json"
)


class Marc2SuffixIdentityPrivateDiscriminatorRequestProofTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_request_remote_proof_is_exact(self):
        ...
        self.assertEqual(
            proof["commit"], "08cef4bfacb126770c1a3a4be2fab58d1f7a276f"
        )
        self.assertEqual(proof["CI_run_id"], 32_450_174_692)
        self.assertEqual(proof["base_python_job_id"], 96_677_085_658)
        self.assertEqual(proof["optional_neuro_job_id"], 96_677_085_404)
