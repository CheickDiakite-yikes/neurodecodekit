...
PROOF = ROOT / "registries/communication_eeg_tesscco_source_readiness_proof.v0.json"
DOCUMENT = ROOT / "docs/COMMUNICATION_EEG_TESSCCO_SOURCE_READINESS_PROOF_CLOSEOUT.md"


class CommunicationEEGTESSCCoSourceReadinessProofTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_readiness_commit_is_remotely_green_and_on_main(self) -> None:
        ...
        self.assertEqual(
            green["commit"], "3ed55ba274b0aef0bb7434867c9c0ef6430f8f37"
        )
        self.assertEqual(green["CI_run_id"], 33_130_065_908)
        self.assertEqual(green["base_python_job_id"], 98_717_252_636)
        self.assertEqual(green["optional_neuro_readers_job_id"], 98_717_252_621)
    ...
    def test_exact_readiness_artifacts_are_hash_size_and_git_bound(self) -> None:
        ...
        self.assertEqual(summary["bytes"], 15_460)
        self.assertEqual(
