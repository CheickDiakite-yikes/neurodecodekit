...
class Marc2VariableWidthPrivateConfirmationAuthorizationDecisionTests(
    unittest.TestCase
):
    @classmethod
    ...
    def test_identity_parent_and_delayed_effect_are_exact(self):
        ...
        self.assertEqual(self.decision["lane_id"], "MARC2-VR16P")
        self.assertEqual(
    ...
    def test_green_request_and_proof_are_exact(self):
        ...
        self.assertEqual(request["commit"], "619469a795a7044a4bbb77cef8986e0a7744473f")
        self.assertEqual(request["CI_run_id"], 32_461_465_238)
        self.assertEqual(request["base_python_job_id"], 96_709_074_413)
        self.assertEqual(request["optional_neuro_job_id"], 96_709_074_203)
        self.assertTrue(request["both_required_jobs_green"])
        self.assertEqual(proof["commit"], self.decision["authorization_parent_commit"])
        self.assertEqual(proof["CI_run_id"], 32_462_345_461)
        self.assertEqual(proof["base_python_job_id"], 96_711_664_860)
        self.assertEqual(proof["optional_neuro_job_id"], 96_711_664_524)
    ...
    def test_actual_message_is_preserved_without_scope_inference(self):
        ...
        self.assertEqual(user["sole_active_Tier_C_packet"], "MARC2-VR16P")
    ...
    def test_bound_request_and_proof_artifacts_are_exact(self):
        ...
        self.assertEqual(sum(row["bytes"] for row in rows), 42_866)
        for row in rows:
    ...
    def test_authority_is_delayed_and_payload_work_remains_closed(self):
        ...
        self.assertTrue(authority["one_VR16A_call_after_stage_1_proof_green"])
    ...
    def test_execution_order_preserves_both_remote_barriers(self):
        ...
        self.assertIn("one_exact_private_structural_read_hash_parse_and_VR16A_call", order)
    ...
    def test_routes_resources_and_output_firewall_are_frozen(self):
        self.assertEqual(
            ...
            [f"MARC2VR16P-R{i}" for i in range(1, 7)],
        )
        self.assertTrue(
        ...
        self.assertEqual(
            (generated["variants"], generated["orders"], generated["replays"]),
            (6, 2, 2),
        )
    ...
    def test_human_decision_states_delayed_effect_and_boundaries(self):
        ...
        self.assertIn("all six registered width variants", text)
