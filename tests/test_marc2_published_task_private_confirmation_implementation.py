...
class Marc2PublishedTaskPrivateConfirmationImplementationTests(unittest.TestCase):
    @classmethod
    ...
    def test_record_is_stage_1_only_or_exactly_proof_closed(self):
        self.assertEqual(
            ...
            "neurodecodekit.marc2_published_task_private_confirmation_implementation",
        )
        self.assertEqual(self.record["lane_id"], "MARC2-VR20P")
        ...
        if proof is None:
            ...
            self.assertEqual(proof["qualification_route"], "MARC2VR20P-G1")
    ...
    def test_generated_measurements_pass_all_caps(self):
        ...
        self.assertEqual(measured["route"], "MARC2VR20P-G1")
    ...
    def test_wrapper_does_not_reference_consumed_private_executor(self):
        ...
        for forbidden in (
            "marc2_first_failure_stable_private_discriminator",
