...
DECISION_PATH = (
    ROOT
    / "registries"
    / "marc1_privacy_preserving_pilot_selection_authorization_decision.v0.json"
)
...
class Marc1PilotSelectionAuthorizationDecisionTests(unittest.TestCase):
    @classmethod
    ...
    def test_decision_is_packet_bound_and_not_yet_effective(self) -> None:
        ...
        self.assertEqual(self.decision["lane_id"], "MARC1-P1A")
        self.assertEqual(
    ...
    def test_green_request_proof_is_exact(self) -> None:
        ...
        self.assertEqual(proof["commit"], "7f1ba0936e4e0266c0210648aa641feab63cd0eb")
        self.assertEqual(proof["push_CI_run_id"], 31_573_969_646)
        self.assertEqual(proof["base_python_job_id"], 94_041_819_046)
        self.assertEqual(proof["optional_neuro_job_id"], 94_041_819_022)
    ...
    def test_authorization_is_conditional_and_metadata_only(self) -> None:
        ...
        self.assertTrue(
            authorization["real_selector_implementation_authorized_after_decision_green"]
        )
        self.assertTrue(
        ...
        self.assertTrue(
            authorization["one_private_and_one_public_metadata_selection_authorized_after_wrapper_green"]
        )
        self.assertTrue(
    ...
    def test_selection_and_resource_caps_match_request(self) -> None:
    ...
    def test_execution_order_requires_both_green_milestones(self) -> None:
        ...
        self.assertLess(
            order.index("generated_and_mocked_real_selector_implementation"),
            order.index("test_commit_push_and_obtain_green_CI_for_exact_real_selector"),
        )
        self.assertLess(
            order.index("test_commit_push_and_obtain_green_CI_for_exact_real_selector"),
        ...
        self.assertLess(
            order.index("pre_consumption_machine_gate_and_private_marker"),
            order.index("one_private_manifest_and_one_public_metadata_selection"),
        )
    ...
    def test_next_gate_and_claim_boundary_are_explicit(self) -> None:
        ...
        self.assertFalse(gate["real_selector_implementation_may_begin_before_green"])
    ...
    def test_human_decision_quotes_message_and_boundaries(self) -> None:
        document = (
            ROOT
            / "docs"
            / "MARC_1_PRIVACY_PRESERVING_PILOT_SELECTION_AUTHORIZATION_DECISION.md"
