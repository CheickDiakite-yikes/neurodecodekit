...
class Marc2F06PrivateFiveRouteImplementationTests(unittest.TestCase):
    @classmethod
    ...
    def test_record_is_stage_1_only_or_exactly_proof_closed(self):
        ...
        self.assertEqual(self.record["lane_id"], "MARC2-VR24P")
        ...
        if proof is None:
            ...
            self.assertEqual(proof["qualification_route"], "MARC2VR24P-G1")
    ...
    def test_generated_measurements_pass_all_caps(self):
        ...
        self.assertEqual(measured["route"], "MARC2VR24P-G1")
        self.assertEqual(measured["paths"], 24)
        self.assertEqual(measured["success_paths"], 4)
        self.assertEqual(measured["refusal_paths"], 20)
        self.assertEqual(measured["VR23A_calls"], 24)
        self.assertEqual(measured["nested_VR20A_calls"], 24)
        self.assertGreaterEqual(measured["direct_refusals"], 80)
