...
DECISION_PATH = (
    ROOT / "registries/marc2_r5_private_discriminator_authorization_decision.v0.json"
)
DOC_PATH = ROOT / "docs/MARC_2_R5_PRIVATE_DISCRIMINATOR_AUTHORIZATION_DECISION.md"


class Marc2R5PrivateDiscriminatorAuthorizationDecisionTests(unittest.TestCase):
    @classmethod
    ...
    def test_identity_parent_and_delayed_effect_are_exact(self):
        ...
        self.assertEqual(self.decision["lane_id"], "MARC2-VR22P")
        self.assertEqual(
    ...
    def test_green_request_and_proof_are_exact(self):
        ...
        self.assertEqual(request["commit"], "c90b5adae161127db8aa8c43d1101db8672b44e0")
        self.assertEqual(request["CI_run_id"], 32_561_578_590)
        self.assertEqual(request["base_python_job_id"], 97_003_859_100)
        self.assertEqual(request["optional_neuro_job_id"], 97_003_859_284)
        self.assertTrue(request["both_required_jobs_green"])
        self.assertEqual(proof["commit"], self.decision["authorization_parent_commit"])
        self.assertEqual(proof["CI_run_id"], 32_562_175_927)
        self.assertEqual(proof["base_python_job_id"], 97_005_357_265)
        self.assertEqual(proof["optional_neuro_job_id"], 97_005_357_323)
    ...
    def test_actual_message_is_preserved_without_scope_inference(self):
        ...
        self.assertEqual(user["sole_active_Tier_C_packet"], "MARC2-VR22P")
    ...
    def test_bound_request_and_proof_artifacts_are_exact(self):
        ...
        self.assertEqual(sum(row["bytes"] for row in rows), 41_746)
        for row in rows:
    ...
    def test_authority_is_delayed_and_payload_work_remains_closed(self):
        ...
        self.assertTrue(authority["one_VR21A_map_call_maximum_after_stage_1_proof_green"])
    ...
    def test_execution_order_preserves_both_remote_barriers(self):
        ...
        self.assertIn(
            "one_exact_private_structural_read_hash_parse_VR20A_and_conditional_VR21A_call",
            order,
        )
    ...
    def test_routes_resources_and_output_firewall_are_frozen(self):
        self.assertEqual(
            ...
            [f"MARC2VR22P-R{i}" for i in range(1, 7)],
        )
        self.assertTrue(
        ...
        self.assertEqual(generated["required_paths"], 12)
        self.assertGreaterEqual(generated["direct_refusal_minimum"], 60)
    ...
    def test_human_decision_states_delayed_effect_and_boundaries(self):
        ...
        self.assertIn("All 12 paths and at least 60", text)
