...
class Marc2SelectionBoundaryPrivateConfirmationImplementationTests(unittest.TestCase):
    @classmethod
    ...
    def test_record_is_stage_1_only_or_exactly_proof_closed(self):
        self.assertEqual(
            ...
            "neurodecodekit.marc2_selection_boundary_private_confirmation_implementation",
        )
        self.assertEqual(self.record["lane_id"], "MARC2-VR26P")
        ...
        if proof is None:
            ...
            self.assertEqual(proof["qualification_route"], "MARC2VR26P-G1")
    ...
    def test_generated_measurements_pass_all_caps(self):
        ...
        self.assertEqual(measured["route"], "MARC2VR26P-G1")
        self.assertEqual(measured["paths"], 40)
        self.assertEqual(measured["success_paths"], 20)
        self.assertEqual(measured["refusal_paths"], 20)
        self.assertEqual(measured["VR25A_calls"], 40)
        self.assertEqual(measured["compatibility_true_paths"], 4)
        self.assertEqual(measured["compatibility_false_paths"], 16)
    ...
    def test_wrapper_does_not_reference_consumed_private_executor(self):
        source = (
            ...
            "marc2_selection_boundary_private_confirmation.py"
        ).read_text(encoding="utf-8")
        for forbidden in (
            "marc2_r5_private_discriminator as",
            "marc2_published_task_private_confirmation",
            "marc2_f06_private_five_route_discriminator as",
            ".codex_work/marc2_r5_private_discriminator/v0",
            ".codex_work/marc2_f06_private_five_route_discriminator/v0",
        ):
