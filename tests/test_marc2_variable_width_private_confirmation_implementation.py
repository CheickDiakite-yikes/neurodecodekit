...
class Marc2VariableWidthPrivateConfirmationImplementationTests(unittest.TestCase):
    @classmethod
    ...
    def test_record_is_stage_1_only_or_exactly_proof_closed(self):
        self.assertEqual(
            ...
            "neurodecodekit.marc2_variable_width_private_confirmation_implementation",
        )
        self.assertEqual(self.record["lane_id"], "MARC2-VR16P")
        ...
        if proof is None:
            ...
            self.assertEqual(proof["qualification_route"], "MARC2VR16P-G1")
    ...
    def test_generated_measurements_pass_all_caps(self):
        ...
        self.assertEqual(measured["route"], "MARC2VR16P-G1")
        self.assertEqual(measured["success_paths"], 24)
        self.assertEqual(measured["VR16A_calls"], 24)
    ...
    def test_wrapper_does_not_reference_consumed_private_executor(self):
        ...
        for forbidden in (
            "marc2_suffix_identity_private_discriminator",
            "MARC2VR15P",
            "marc2_p15_private_confirmation",
            "MARC2VR12P",
        ):
