...
class InventoryDistributionPrivateDiscriminatorRequestProofTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_request_remote_proof_is_exact(self):
        ...
        self.assertEqual(
            proof["commit"], "8e49ac080ca31fe9788ebfdfe9fc355a9a58218c"
        )
        self.assertEqual(proof["CI_run_id"], 32_621_561_090)
        self.assertEqual(proof["base_python_job_id"], 97_150_361_897)
        self.assertEqual(proof["optional_neuro_job_id"], 97_150_361_782)
    ...
    def test_every_request_artifact_matches_bytes_hash_and_git_blob(self):
        ...
        self.assertEqual(sum(row["bytes"] for row in rows), 29_866)
        for row in rows:
    ...
    def test_scope_is_unchanged_and_aggregate_only(self):
        ...
        self.assertEqual(scope["fixed_input_bytes"], 161_574)
