...
class Marc2EligibleTotalDirectionPrivateDiscriminatorImplementationTests(
    unittest.TestCase
):
    @classmethod
    ...
    def test_record_is_stage_1_only_or_exactly_proof_closed(self):
        self.assertEqual(
            ...
            "neurodecodekit.marc2_eligible_total_direction_private_discriminator_implementation",
        )
        self.assertEqual(self.record["lane_id"], "MARC2-VR32P")
        ...
        if proof is None:
            ...
            self.assertEqual(proof["qualification_route"], "MARC2VR32P-G1")
    ...
    def test_generated_measurements_pass_every_cap(self):
        ...
        self.assertEqual(measured["route"], "MARC2VR32P-G1")
    ...
    def test_wrapper_does_not_import_or_name_consumed_private_executors(self):
        source = (
            ...
            "marc2_eligible_total_direction_private_discriminator.py"
        ...
        for forbidden in (
            ...
            ".codex_work/marc2_inventory_distribution_private_discriminator",
        ):
