...
DOC = ROOT / "docs/MARC_2_EXACT_COUNT_PRIVATE_CONFIRMATION_RESULT.md"


class Marc2ExactCountPrivateConfirmationPrivateResultTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_green_proof_chain_precedes_execution(self):
        ...
        self.assertEqual(
            ...
            "a0e36afd08bc9d6ae9429e9471d4650f6093e406",
        )
        self.assertEqual(
            proof["proof_closeout_commit"],
            "c863fd4b5bb9c866d6bc5683cb74c9fbeab6d8d8",
        )
        self.assertEqual(proof["proof_closeout_CI_run_id"], 32_641_201_220)
    ...
    def test_one_shot_result_is_exact_and_bounded(self):
        ...
        self.assertEqual(self.result["route"], "MARC2VR34P-R2")
        self.assertEqual(measurements["input_bytes"], 418_755)
        self.assertEqual(measurements["readiness_samples"], 3)
        self.assertEqual(measurements["readiness_sleeps"], 2)
        self.assertEqual(measurements["source_content_opens"], 1)
        self.assertEqual(measurements["strict_JSON_parses"], 1)
        self.assertEqual(measurements["VR33A_calls"], 1)
    ...
    def test_repaired_readiness_protocol_conforms_without_claim_upgrade(self):
        ...
        self.assertEqual(fidelity["readiness_sample_count_excess"], 0)
    ...
    def test_consumption_and_forbidden_boundaries_are_closed(self):
        ...
        self.assertFalse(self.result["next_gate"]["VR34P_rerun_or_repair_authorized"])
    ...
    def test_human_result_states_route_protocol_and_claim_boundary(self):
        ...
        self.assertIn("Protocol conformance does not reveal", text)
