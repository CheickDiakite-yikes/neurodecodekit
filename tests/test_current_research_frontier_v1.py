...
REGISTRY = ROOT / "registries/current_research_frontier.v1.json"


class CurrentResearchFrontierV1Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_identity_and_active_lane_are_exact(self):
        ...
        self.assertEqual(self.frontier["schema_version"], "0.2.0")
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "42bbf7d87774ae2c2ac1ba6e42831c2bcff5e7833b8ab7c93c186beea9fee6ee",
        )
    ...
    def test_fresh_replication_and_active_preflight_are_exact(self):
        ...
        self.assertEqual(
            request["status"],
            "consumed_H0_transport_refusal_lane_parked",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            activation["commit"],
            "e3adab26e867f6de7e56f406f59ede51718b577c",
        )
        self.assertEqual(activation["CI_run_id"], 33_261_346_763)
        ...
        self.assertEqual(result["execution_id"], "DREYER-C5R-1-HL2-R0")
        self.assertEqual(result["route"], "DREYER-H0")
        self.assertEqual(result["refusal_code"], "HL2-TRANSPORT")
        self.assertEqual(result["real_HTTP_GET_requests"], 1)
        ...
        self.assertFalse(result["retry_or_rerun_allowed"])
    ...
    def test_all_five_scientific_goals_and_claims_remain_unestablished(self):
        ...
        for key, value in claims.items():
            if key not in {
                ...
                "Dreyer_HL2_invocation_consumed",
                "Dreyer_HL2_route",
            }:
        ...
        self.assertTrue(claims["Dreyer_HL2_invocation_consumed"])
        self.assertEqual(claims["Dreyer_HL2_route"], "DREYER-H0")
        self.assertEqual(claims["Dreyer_network_body_bytes"], 0)
        self.assertEqual(claims["Dreyer_fixed_header_reads"], 0)
