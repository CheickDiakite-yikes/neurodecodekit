...
- **MARC2-VR11P private discriminator wrapper:** an all-false packet binds
  ...
  emitted 7,268 aggregate bytes, and retained zero. The implementation proof
  remains null, so real `execute` refuses before readiness or private access.
  No private source, archive member, neural payload, target, model, prediction,
  or score was accessed; FW2 and CIL1 remain closed.
