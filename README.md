...
- **MARC-1 is the next scientific effect lane:** WO9R is a real positive
  ...
  That decision must itself become remotely green before generated/mock
  wrapper work begins. A public request remains closed until the exact wrapper
  is separately committed, pushed, and green; whole-download, member, neural,
  model, score, and scientific-claim operations remain forbidden.
