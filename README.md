...
| MARC-2 confound triangulation | A five-work-order plan is designed to test task choice, conditional EEG information beyond peripheral controls, one orthogonal cohort, and a Spanish inner-speech control ladder before any LLM can receive neural evidence | After generated VR25A/VR27A/VR29A controls and proof-gated structural narrowing, the sole VR30P pass consumed at R1: the filtered eligible total differs from the registered public total of 195. It exposed no count, participant, or cohort and accessed no neural payload, target, model, prediction, or score. This is a real structural blocker localization, not a decoding result |
