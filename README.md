...
| Test and release surface | 587 local unittests with 3 expected skips; 584 pytest passes plus 269 subtests; 555 dependency-light Python tests with 121 expected skips | Loop 40 local verification is green; branch push and draft-PR CI are pending | Makes research contracts, candidate selection, source bindings, access order, tamper checks, and authorization boundaries executable on ordinary hardware |
