...
| Test and release surface | 527 local unittests with 3 expected skips; 524 pytest passes plus 240 subtests; 495 dependency-light Python tests with 121 expected skips | Loop 36 local verification is green; remote commit and CI identities are pending the tested push | Makes research contracts, candidate selection, source bindings, access order, tamper checks, and authorization boundaries executable on ordinary hardware |
