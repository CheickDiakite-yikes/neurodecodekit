...
| MARC-1 next-effect research | 2 selected licensed axes; 23-person EEG/EOG/acceleration source; 45-person EEG/EMG/encoder source; 12 invariants; 0 payload/model/score operations | Tier A research only; the 13.59 GB monolith is forbidden as a whole download and the stronger unlicensed self-paced source is parked | Makes the next positive result answer "better than what?" by requiring the weaker of two cue/ocular and muscle/kinematic control margins to pass |
...
- **MARC-1 is the next scientific effect lane:** WO9R is a real positive
  ...
  payloads remain capped below 8 GiB. A scientifically attractive ten-person
