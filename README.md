...
| MARC1-P1 generated pilot selector | 1,227 + 55 generated rows; 12 preregistered participants per axis; 72 Freewill bundles/288 members; 12 Wrist archives; 36/36 refusals; 15/15 gates; 0 real operations | Contract `d121806` passed CI `31569417204` before implementation; development `MARC1PSG-R1` used 873,348 input and 182,563 output bytes in 0.227 sec at 32.8 MB RSS; registered closeout awaits implementation CI | Proves deterministic, private, size-independent pilot selection mechanics under an 8-GiB ceiling; adds no neural or thought-to-text evidence |
...
- **MARC-1 is the next scientific effect lane:** WO9R is a real positive
  ...
  disposable development run passed constructed `MARC1PSG-R1` in 0.282
  seconds at 33.2 MB reported RSS with zero real, network, signal, target,
  model, score, or claim operations; its 182,563 output bytes were removed.
  This implementation must itself become remotely green before one registered
  generated closeout. Real metadata selection and acquisition remain a later
  Tier C gate.
