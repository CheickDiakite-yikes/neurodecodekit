...
| MARC-2 confound triangulation | VR38A passed 40 generated selection paths and 101 adversarial refusals; all 20 accepted optional-drift cases preserved one exact 16-person, 96-bundle, 384-member structural selection using only runs 1-3, and exact implementation `7ef4a8d` passed both CI jobs | This removes an unnecessary exact-195 inventory gate and makes the next structural pass terminal: freeze at least 12 people or park Freewill. It is engineering proof only; no private cohort, neural payload, target, model, prediction, score, or neural advantage was established |
