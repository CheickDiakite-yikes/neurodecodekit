...
| Test and release surface | 394 local unittests with 3 expected skips; 391 pytest passes plus 184 subtests; 362 dependency-light Python 3.12 tests with 121 expected skips | local shell verified; Loop 28 research commit `a55b7e6` and draft PR #7 are green | Makes research contracts, candidate selection, source bindings, access order, tamper checks, and authorization boundaries executable on ordinary hardware |
...
| Loop 25-28 focused boundary suite | 0.080 sec wall | 27,639,808 bytes | no generated payload |
...
| Complete optional-neuro/ML test runners | 22.70 sec unittest / 23.75 sec pytest wall | 587,792,384 bytes max | temporary test output only |
...
- Loops 25-44: a primary-source-informed tranche spans causal
  ...
  experiment remains `Not Started`; Loops 29-44 remain `Not Started`. All 20
