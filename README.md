...
| MARC1-P1 frozen pilot selector | 12 preregistered participants per axis; 72 Freewill run bundles; 288 core Freewill members; 12 Wrist archives; cross-day and held-out-run splits; 8-GiB joint ceiling; 36 refusals | DOI-bound SHA-256 rank is frozen before private inventory or Wrist metadata access; generated implementation requires this contract to pass both CI jobs | Prevents size, CRC, target, quality, or outcome cherry-picking while preserving a participant-level path to the first confound-resistant EEG claim |
