...
- **MARC2-VR10B five-route discriminator result:** registration `d642eae`
  ...
  Exact implementation/result remote proof is pending. This is generated
  route-separation evidence only: there is no private executor, private cause,
...
| [registries/marc2_f03_five_route_discriminator_implementation.v0.json](registries/marc2_f03_five_route_discriminator_implementation.v0.json) | machine-readable implementation hashes, green registration proof, six-route mechanics, local verification, zero counters, and pending remote proof |
