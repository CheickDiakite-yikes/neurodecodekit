...
autonomous milestone is synthetic implementation and calibration only, under
one CPU thread, four total training runs, at most 1,800 steps, 600 seconds,
1 GiB peak RSS, 16 MiB generated output, and zero real-data downloads. See
