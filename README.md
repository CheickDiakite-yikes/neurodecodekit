...
| Test and release surface | 558 local unittests with 3 expected skips; 555 pytest passes plus 254 subtests; 526 dependency-light Python tests with 121 expected skips | Loop 38 is locally verified; commit and CI identities are recorded after push | Makes research contracts, candidate selection, source bindings, access order, tamper checks, and authorization boundaries executable on ordinary hardware |
