...
## Current Frontier: MARC2-VR23A Generated F06 Decomposition
...
`9e1b121` passed both jobs in CI `32596999769`. The proof-only closeout now
binds the two preproof registries and seven exact Git blobs without repeating
qualification or touching private state. Commit, push, and green this
closeout. Only afterward may Tier A prepare a new all-false Tier C packet;
another private read or cohort freeze still requires a fresh decision. This
separates five public F06 classes on generated full-scale manifests but does
not reveal the real VR22P class. No neural payload, target, model, prediction,
score, FW2/CIL1, or scientific claim is open.
