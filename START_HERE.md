...
Exact implementation `bfb0dcb` passed Base job `96674484190`, Optional job
`96674484279`, and CI `32449260503`. The proof-only closeout repeats no
qualification or private operation. This remains structural engineering
evidence only: it does not identify the consumed private failure or freeze a
cohort, and it accessed no ignored path, private source, archive member, neural
payload, target, model, prediction, or score. FW2 and CIL1 remain ineligible.
