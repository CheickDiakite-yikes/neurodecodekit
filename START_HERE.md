...
The generated fixed-path wrapper now passes 24/24 paths: G1 and R1-R5 each
...
no private cohort-manifest surface. Commit, push, and green this exact
implementation, then add and green a proof-only closeout without repeating
qualification. No readiness, private path, neural payload, target, model,
prediction, score, FW2/CIL1, or scientific claim is open before both barriers.
