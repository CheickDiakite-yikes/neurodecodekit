...
qualification. Do not touch `.codex_work`, consumed/private state, archives,
neural data, targets, models, predictions, scores, FW2/CIL1, devices, streams,
releases, or claims. Another private direction read requires a new all-false
Tier C packet and fresh packet-bound decision.
