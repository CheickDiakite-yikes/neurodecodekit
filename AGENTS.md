...
The current safe lane is `MARC2-VR15A`. Registration
`185fbc54366fd0eaf0ed4e994511e4485514b53e` passed Base Python job
`96670618009`, Optional Neuro Readers job `96670617843`, and CI
`32447836662` before generated implementation. Read
`docs/MARC_2_SUFFIX_IDENTITY_GRAMMAR_DECOMPOSITION_IMPLEMENTATION.md`,
`docs/MARC_2_SUFFIX_IDENTITY_GRAMMAR_DECOMPOSITION_RESULT.md`, their
registries, module, and tests. Local `MARC2VR15A-G1` passes 68 exact unchanged
VR12A calls across 17 generated cases, two orders, and two replays. G1 and
R1-R16 each appear four times; all 15 single-class witnesses reach exact
F03/P15; 70 direct refusals pass. The measured run processed 29,199,868
generated bytes in 3.9292239159694873 seconds at 49,037,312-byte peak RSS,
emitted 6,587 aggregate bytes, and retained zero. The complete base suite
passes 4,380 tests with 204 expected skips. Exact implementation
`bfb0dcb7752433b4af841d57bbfcbf613a341124` passed Base job `96674484190`,
Optional job `96674484279`, and CI `32449260503`. Read the proof-only closeout;
it repeats no qualification or private operation. Tier A may prepare a new
all-false private packet, but no private read is authorized.

VR15A is artifact-only and generated-only. Do not touch ignored/private state,
VR13P/VR14P consumed output, a structural source, archive member, neural
payload, target, model, prediction, score, FW2, or CIL1. The generated routes
