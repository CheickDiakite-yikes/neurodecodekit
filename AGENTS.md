...
Commit, push, and green this exact Stage 1 implementation. Then add and green
a proof-only closeout without repeating qualification. Do not collect
readiness or touch `.codex_work`, the private source, or an output root before
both barriers.
