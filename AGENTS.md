...
No protected Stage C contract exists. The next permissible work is Tier A
artifact-only synthesis or a prospective design proposal; no protected or
real-data experiment is open. Do not stat/hash/read the S21 cache, perform
another real-data parameter update, reopen the 11 check targets, acquire S24,
substitute another participant, open S25, rerun Stage C, or promote a claim
