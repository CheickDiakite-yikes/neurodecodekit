...
Commit, push, and green the exact VR23A implementation and result, then add a
proof-only closeout without repeating qualification. Only after that closeout
is remotely green may Tier A prepare a new all-false Tier C private
