...
VR16A is generated-only. It proves the adapter mechanics, not that the real
source passes. Commit, push, and green the exact implementation/result before
preparing any all-false private-confirmation packet. A real structural read,
