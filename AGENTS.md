...
and retains zero output. The exact implementation and result must be committed,
pushed, and pass both CI jobs before any later private-wrapper registration.
This work authorizes no private read, cohort, archive member, neural payload,
...
eight route classes. Exact implementation and result are pending commit, push,
and both remote-green jobs.
Do not touch ignored MARC2 paths, consumed roots, certificates, markers,
retained sources, archive members, neural data, targets, models, predictions,
or scores. Any future private read remains a new Tier C packet and fresh
packet-bound decision.
