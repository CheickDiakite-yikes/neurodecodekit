...
`32601257065`. Read
`docs/MARC_2_F06_PRIVATE_FIVE_ROUTE_DISCRIMINATOR_PROOF_CLOSEOUT.md`; it binds
the 7,138-byte preproof registry and four implementation Git blobs without
repeating qualification or touching private state. Commit, push, and green
this closeout before collecting readiness or touching `.codex_work`, the
private source, or an output root.
