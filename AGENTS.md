...
Immediate gate: commit, push, and green this exact implementation and result,
then prepare a proof-only closeout without requalification or private access.
Another private discriminator requires a new frozen Tier C packet and fresh
decision. Archive, neural, target, model, score, FW2/CIL1, device, release,
