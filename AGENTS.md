...
`MARC2-VR31A` has passed its one generated qualification. Read its
preregistration, implementation document, module, and two machine records.
...
Generated route `MARC2VR31A-G1` passed all 32 paths with 32 unchanged VR29A
calls, eight R1 direction comparisons, one immutable threshold predicate,
G1/G2/R1/R2/R3 counts 4/4/4/4/16, 78 direct refusals, exact replay, source
immutability, and zero count or output retention. It processed 14,137,216
generated bytes in 2.8035786249674857 seconds at 39,174,144-byte peak RSS.
...
`97165896610`, and CI `32627856478`. Read the VR31A proof-only closeout. It
binds both preproof registries and eight exact Git blobs without repeating
qualification or touching private state.

Immediate gate: commit, push, and green the exact proof-only closeout. Do not
touch `.codex_work`, consumed/private state, archives, neural data, targets,
models, predictions, scores, FW2/CIL1, devices, streams, releases, or claims.
Only after closeout proof may Tier A prepare an all-false private direction
packet; a fresh Tier C decision is still required before any private read.
