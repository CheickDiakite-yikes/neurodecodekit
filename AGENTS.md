...
`MARC2-VR30P` Stage 1 is remotely green and its proof-only closeout is pending
remote proof. The packet-bound decision
`2bd811e30991997b8b7616e4c9451899f579dc94` passed CI `32623171395` before
implementation. Exact Stage 1 `b20d632c184382716509197c2fe1617058a8e230`
passed Base Python job `97157732938`, Optional Neuro Readers job
`97157733105`, and CI `32624543064`. Read the VR30P authorization packet,
request proof, decision, implementation, result, and proof-closeout artifacts
first.
...
repeating qualification or touching private state. Only after both jobs pass
may the already authorized one-shot Stage 2 readiness and 418,755-byte target-
free structural read run. Before that proof, do not call `execute`, touch any
consumed/private state, or infer a route.
