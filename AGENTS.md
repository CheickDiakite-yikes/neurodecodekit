...
job `97207526045`, Optional job `97207525966`, and CI `32644887730`. Read the
VR35A proof closeout; it binds the two preproof registry hashes and eight exact
Git blobs without repeating qualification or touching private state.

Immediate gate: commit, push, and green the exact proof-only closeout. This
proves a generated architectural mechanism and repair, not that mixed-task
surplus caused private VR34P R2. Do not touch any private/ignored source,
readiness or consumed state, archive, neural payload, target, model, score,
FW2/CIL1, device, release, or claim surface. After closeout proof, Tier A may
prepare an all-false private cohort-confirmation packet, which remains a
