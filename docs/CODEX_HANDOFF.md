...
> Current MARC2-VR29A generated qualification, 2026-08-23: registration
...
> peak RSS and emitted 2,880 aggregate bytes. Immediate gate: commit, push,
> and green this exact implementation, then separately green a proof-only
> closeout without rerunning qualification. VR29A has no private executor and
> does not identify the consumed private R1 subclass; consumed VR28P state and
> every archive, neural, target, model, score, FW2/CIL1, device, release, and
