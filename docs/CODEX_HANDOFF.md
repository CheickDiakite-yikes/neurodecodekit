...
> repeat qualification. Immediate gate: commit, push, and green the exact
> implementation/result, then add a proof-only closeout. This does not prove
> mixed-task surplus caused private VR34P R2 or establish a real cohort. No
> private, archive, neural, target, model, score, FW2/CIL1, device, release,
