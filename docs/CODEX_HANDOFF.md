...
> generated bytes. Do not repeat qualification. Exact Stage 1 `8179f6f`
> passed Base `97220389999`, Optional `97220389862`, and CI `32650171033`.
> The proof-only closeout now binds that proof and every preproof artifact.
> Immediate gate: commit, push, and green that exact closeout. Until it passes,
> do not touch `.codex_work`, private/consumed
> state, archive, neural, target, model, score, FW2/CIL1, device, release, or
> claim surfaces.
