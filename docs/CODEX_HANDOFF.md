...
> experiment operation occurred. Commit and push this exact implementation,
> require both CI jobs green, then and only then consume the one registered
> acquisition. The inventory remains nine files and 23,248,224 bytes. The
> user's later 10 GB ceiling is unused future headroom, not permission to
> expand this contract. Preserve the unrelated tracker inspection NDJSON.
>
