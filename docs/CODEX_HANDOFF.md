...
> Current MARC2-VR20P proof closeout, 2026-08-22: decision `49b0f4b` passed Base job
> `96991921763`, Optional job `96991921631`, and CI `32556695686` before
> implementation. Generated `MARC2VR20P-G1` passes 24/24 paths with G1 and
> R2-R6 each appearing four times, 24 unchanged VR20A calls, and 91 direct
> refusals. It processed 10,602,864 generated bytes in 1.198090 seconds at
> 35,504,128-byte peak RSS, reached 222,998 temporary bytes, and retained zero.
> Exact Stage 1 implementation `81784e7` passed Base job `96994090562`,
> Optional job `96994090593`, and CI `32557573872`. Commit, push, and green
> the proof-only closeout. Before that final barrier passes, do not touch readiness,
> `.codex_work`, the private source, consumed VR18P state, or an output root.
> Neural payload, target, model, score, FW2/CIL1, and claims remain closed.
