...
prediction sets, a strict aggregate freeze, and isolated scorer. One generated
128-run qualification passed in 8.674020 seconds at 263,618,560-byte peak RSS
with 5,683,285 generated bytes and zero real/network/target access; output was
removed. Commit and push this exact implementation, then require both CI jobs
green before the one acquisition. Require the target-free freeze green before
the two opposite target views open together once.
