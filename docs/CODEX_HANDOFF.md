...
> Current MARC2-VR15A result, 2026-08-21: registration `185fbc5` passed Base
> job `96670618009`, Optional job `96670617843`, and CI `32447836662` before
> implementation. Read the VR15A implementation/result docs and registries.
> Generated `MARC2VR15A-G1` passes all 68 paths: G1 and R1-R16 each occur four
> times, all 15 single-class witnesses reach exact VR12A F03/P15, both replays
> and source orders agree, all 70 direct refusals pass, and sources remain
> unchanged. The measured pass used 29,199,868 generated bytes, 3.929224
> seconds, 49,037,312-byte peak RSS, 6,587 output bytes, and zero retention.
> The complete base suite passes 4,380 tests with 204 expected skips. Exact
> implementation `bfb0dcb` passed Base job `96674484190`, Optional job
> `96674484279`, and CI `32449260503`. The proof closeout repeats no
> qualification or private operation. Tier A may prepare an all-false private
> packet, but do not touch private/ignored paths, consumed VR13P/VR14P state,
