...
> generated bytes. Do not repeat qualification. Immediate gate: commit, push,
> and green the exact implementation/result, then green its proof-only
> closeout. Until both pass, do not touch `.codex_work`, private/consumed
