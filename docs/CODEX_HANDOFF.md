...
> proof-only closeout binds both preproof registries and seven exact Git blobs
> without repeating qualification. Commit, push, and green that closeout. Do
> not touch consumed VR22P or any private/ignored source.
> Another private read requires a new all-false Tier C packet and fresh
> decision. Neural payload, targets, models, scores, FW2/CIL1, release, and
