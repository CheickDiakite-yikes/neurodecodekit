...
> Current MARC2-VR25A implementation, 2026-08-22: registration `ad8be21`
> passed Base job `97105227375`, Optional job `97105227440`, and CI
> `32603540967` before implementation. The one generated qualification passed
> 40/40 paths with route counts G1=4, G2=16, R1=12, R2=4, R3=4; all 20
> accepted paths shared one exact semantic selection, source-exact selected-
> name, split, and reservation identity. All 72 direct refusals passed. The
> run processed 24,580,902 generated bytes in 3.250688 seconds at 48,185,344-
> byte peak RSS and retained zero. Commit, push, and green the exact
> implementation and result, then add a proof-only closeout without rerunning
> qualification. Remote proof is currently null. No private packet, consumed
> state, archive member, neural payload, target, model, score, FW2/CIL1, or
