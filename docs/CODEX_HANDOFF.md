...
> VR8B now freezes that generated-only diagnostic relay across a 1,227-entry
> exact parser/producer path and F02/F03/F04 route matrix. Commit, push, and
> require both jobs green for its exact registration before implementation.
> Do not touch a consumed or ignored path, retained source, archive member,
> neural payload, target, model, score, FW2, or CIL1 surface.
