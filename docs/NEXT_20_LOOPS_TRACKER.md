...
> **Immediate gate (2026-08-23):** VR36P decision `fd08dd6` passed both jobs
> in CI `32648347577`. The sole generated G1 qualification passed all 40
> paths, 111 refusals, exact replay, and zero private operations. Commit, push,
> and green the exact implementation/result, then green a proof-only closeout
> without requalification. Every
...
green a proof-only closeout before the one private invocation.
