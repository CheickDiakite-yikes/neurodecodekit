...
implementation. The standard-library in-memory adapter now exercises all
eight profile/order paths, preserves the exact selection identity, and refuses
all 58 mutations across eight routes. One development preflight used 3,435,280
generated bytes in 0.511378 seconds at 35,356,672-byte peak RSS and retained
zero output. Thirty-two focused, 3,575 dependency-light, and 3,646
optional-enabled tests pass locally.

Current status: exact implementation remote proof pending. Commit, push, and
require both CI jobs green before the single measured generated closeout. LA2
remains consumed, FW2 remains closed, and any future private structural read
still requires a separately named generated-qualified executor, all-false Tier
C request, and fresh packet-bound maintainer decision.
