...
> **Immediate gate (2026-08-23):** MARC2-VR33A passed its sole generated
> qualification at G1 after green registration `23adf07`. Commit, push, and
> green the exact implementation, then add a proof-only closeout without
...
then add a proof-only closeout without repeating qualification. VR32P remains
