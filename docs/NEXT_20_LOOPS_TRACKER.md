...
> **Immediate gate (2026-08-23):** VR37A registration `a677e7a` passed both
> jobs in CI `32652807264` before its sole generated qualification. All 24
> paths passed with G1/R1-R5 x4, 24 VR35A calls, 87 direct refusals, exact
> replay, and zero retention. Commit, push, and green the exact implementation
> and result, then prepare a proof-only closeout without requalification or
> private access. Private, archive, neural, target, model, score, FW2/CIL1,
...
then prepare a proof-only closeout without repeating qualification. A future
