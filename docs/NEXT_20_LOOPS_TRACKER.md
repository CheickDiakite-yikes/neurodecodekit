...
> 39,174,144-byte peak RSS. Implementation must become remotely green before a
> proof-only closeout; no private or neural operation is open.
...
### MARC2-VR31A - Generated Eligible-Total Direction Qualified
...
qualification. Any private direction check remains Tier C; no neural or
scientific surface is open.
