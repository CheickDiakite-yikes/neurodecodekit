...
> **Immediate gate (2026-08-23):** VR38A registration `25205b1` passed CI
> `32670514251` before its sole generated qualification. All 40 paths and 101
> direct refusals passed; 20 accepted paths shared one exact 16-subject,
> 96-bundle, 384-member structural selection. Commit, push, and green the exact
> implementation/result, then add a proof-only closeout without repeating
> qualification. The next private structural packet must freeze at least 12
> participants or park Freewill; archive, neural, target, model, score,
> FW2/CIL1, and claim surfaces remain closed.
...
bytes, and retained zero. Immediate gate: commit, push, and green the exact
implementation/result, then add a proof-only closeout. The next Tier C
