...
> **Immediate update (2026-08-23):** VR31A registration `eeab678` passed CI
> `32626878097` before implementation. The sole generated qualification
> returned `MARC2VR31A-G1`: 32/32 paths, 32 unchanged VR29A calls, eight R1
> direction comparisons, G1/G2/R1/R2/R3 counts 4/4/4/4/16, 78 direct
> refusals, exact replay, zero count retention, and zero output retention. It
> processed 14,137,216 generated bytes in 2.8035786249674857 seconds at
> 39,174,144-byte peak RSS. Exact implementation `3553fa4` passed Base job
> `97165896566`, Optional job `97165896610`, and CI `32627856478`. Its
> proof-only closeout now binds both preproof registries and eight exact Git
> blobs; no private or neural operation is open.
...
### MARC2-VR31A - Exact Implementation Green; Proof Closeout Pending
...
Immediate gate: commit, push, and green the exact closeout without repeating
qualification or touching private state. Only then may an all-false private
direction packet be prepared; any private read still requires a fresh Tier C
decision.
