...
> **Immediate update (2026-08-23):** exact VR32P decision `cb80d07` passed Base
> job `97173642868`, Optional job `97173642874`, and CI `32630976806`. One
> generated Stage 1 pass completed all 32 paths with exact 4/4/4/4/16 routes,
> 32 VR31A calls, eight direction comparisons, 152 refusals, and zero
> retention. Stage 1 and a separate proof closeout must become remotely green
> before the one authorized private structural direction check.
...
### MARC2-VR32P - Generated Stage 1 Pending Remote Proof
...
Immediate gate: commit, push, and green exact Stage 1, then create and
separately green a proof-only closeout without repeating qualification. Only
after both barriers may the registered one-shot structural check execute.
