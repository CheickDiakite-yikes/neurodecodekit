...
### MARC2-VR13A - R4 Residual Decomposition (Generated Pass; Proof Pending)
...
The exact implementation/result artifact set is not yet remotely proven; both
registries keep remote proof null. Next gate: commit, push, and green both CI
jobs. Only after that proof may an all-false private-discriminator packet be
prepared. A private read still requires a fresh Tier C decision.
