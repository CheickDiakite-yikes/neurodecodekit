...
Status: **Stage G passed once; closeout remote green pending**
...
Current gate: commit, push, and remotely green the exact Stage G closeout.
Stage M metadata and every real operation remain closed pending a separate
exact Tier C decision. Stage G is consumed and must not be repeated.
